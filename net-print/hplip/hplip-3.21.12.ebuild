...
PATCHES=(
	"${FILESDIR}/01-disable_upgrade.patch"
	"${FILESDIR}/02-Add-include-cups-ppd.h-in-various-places-as-CUPS-2.2.patch"
	"${FILESDIR}/03-Fix-handling-of-unicode-filenames-in-sixext.py.patch"
	"${FILESDIR}/04-python3.diff"
	"${FILESDIR}/05-hplip-configure-python.patch"
	"${FILESDIR}/06-hplip-3.21.4-remove-imageprocessor.patch"
)
